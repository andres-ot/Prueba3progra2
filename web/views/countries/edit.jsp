        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-push-4">
                ...
                <% 
                        ...
                        con.setConsult("select * from countries where country_id='"+id+"'");
                    %>
                <form action="../../ServCountr?edit=yes" method="post">
                    <div class="form-group">
                        ...
                        <div>
                         ...
                         <input type="text" name="cname" value='<% out.println(""+con.getResult().getString("name")); %>' class="form-control" >
                    </div>
