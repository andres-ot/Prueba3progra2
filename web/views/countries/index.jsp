                    ...
                    <tbody>
                         <%
                                ...
                                while (filas.next()) {
                                    ...
                                    out.println("<td>"+ filas.getString("createdby")+"</td>");
                                    out.println("<td>");
                                    out.println("<a href='../../ServCountr?delete=" + filas.getString("country_id") + "' class='btn btn-danger btn-xs'>Eliminar</a>");
                                    out.println("<a href='edit.jsp?edit=" + filas.getString("country_id") + "' class='btn btn-primary btn-xs'>Editar</a>");
                                    out.println("</td>");
