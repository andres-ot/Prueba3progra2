        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-push-4">
                ...
                <% 
                        ...
                        con.setConsult("select * from cities where city_id='"+id+"'");
                    %>
                <form action="../../ServCity?edit=yes" method="post">
                    <div class="form-group">
                        <% while(con.getResult().next()){  %>
                        <div>
                            <caption>ID</caption>
                            <input type="text" readonly="true" value='<% out.println(""+con.getResult().getString("country_id")); %>' name="id" class="form-control">
                        </div>
                         
                         <caption>Nombre</caption>
                         <input type="text" name="citname" value='<% out.println(""+con.getResult().getString("name")); %>' class="form-control" >
                         <caption>Pais</caption>
                         <input type="text" name="countid" value='<% out.println(""+con.getResult().getString("country_id")); %>' class="form-control" >
                    </div>
