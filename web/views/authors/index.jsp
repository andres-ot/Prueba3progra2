                        ...
                        <tbody>
                            ...
                            <%
                                while (filas.next()) {
                                    ...
                                    out.println("<td>" + "<a href='../../ServAuthor?delete=" + filas.getString("author_id") + "' class='btn btn-danger'>Eliminar</a>" + "</td>");
                                    out.println("<td>" + "<a href='edit.jsp?edit=" + filas.getString("author_id") + "' class='btn btn-primary'>Editar</a>" + "</td>");
